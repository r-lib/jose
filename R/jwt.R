...
#' @param size bitsize of sha2 signature,
#'  i.e. \code{sha256}, \code{sha384} or \code{sha512}.
#'  Only for HMAC/RSA, not applicable for ECDSA keys.
#' @param header named list with additional parameter fields
...
#' @param key path or object with RSA or EC private key,
#'  see \link[openssl:read_key]{openssl::read_key}.
#' @param pubkey path or object with RSA or EC public key,
#'  see \link[openssl:read_pubkey]{openssl::read_pubkey}.
#' @param exp integer expiracy time in seconds
